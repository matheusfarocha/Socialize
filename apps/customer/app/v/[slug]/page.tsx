...
function ReadOnlyCanvas({
  ...
  return (
    ...
    >
      ...
      {selectedTableMeta && (
        <div
          className="absolute left-3 top-3 z-20 w-[min(18rem,calc(100%-1.5rem))] rounded-[1.5rem] bg-surface/95 p-3.5 shadow-xl ring-1 ring-outline-variant/10 backdrop-blur-sm"
        ...
        >
          <div className="flex items-start justify-between gap-3">
            ...
            <button
              ...
              className="rounded-full bg-surface-container-high px-3 py-1.5 text-[11px] font-semibold text-on-surface"
            >
              Close
            </button>
          </div>
                  ...
                  {visibleOccupants.map((occupant, index) => {
                    ...
                    return (
                      <button
                        ...
                        onClick={() =>
                          setSpotlightSessionId((current) =>
                            current === occupant.sessionId ? null : occupant.sessionId,
                          )
                        }
